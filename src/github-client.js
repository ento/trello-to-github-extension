// https://github.com/philschatz/gh-board/blob/master/src/github-client.js
import _ from 'underscore';
import EventEmitter from 'events';
import Octo from 'octokat/src/base';
import SimpleVerbsPlugin from 'octokat/src/plugins/simple-verbs';
import NativePromiseOnlyPlugin from 'octokat/src/plugins/promise/native-only';
import AuthorizationPlugin from 'octokat/src/plugins/authorization';
import CamelCasePlugin from 'octokat/src/plugins/camel-case';
import CacheHandlerPlugin from 'octokat/src/plugins/cache-handler';
