...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rx = __webpack_require__(28);
	...
	var _trelloConnector = __webpack_require__(92);

	var _trelloConnector2 = _interopRequireDefault(_trelloConnector);

	var _githubConnector = __webpack_require__(93);

	var _githubConnector2 = _interopRequireDefault(_githubConnector);

	var _messageDriver = __webpack_require__(94);
	...
	function Header() {
	  return {
	    DOM: Observable.return((0, _dom.div)({ className: 'row' }, [(0, _dom.div)({ className: 'large-12 columns' }, [(0, _dom.h1)('Trello to GitHub Settings')])]))
	  };
	}

	function Footer() {
	  return {
	    DOM: Observable.return((0, _dom.div)("=== footer ==="))
	  };
	}
	...
	function main(sources) {
	  ...
	  var view = function view(state) {
	    return {
	      DOM: Observable.combineLatest(Header().DOM, (0, _trelloConnector2.default)(sources).DOM, githubConnector.DOM, Footer().DOM, function (header, trello, github, footer) {
	        return (0, _dom.div)([header, trello, github, footer]);
	      })
	    };
	  };

	  var githubConnector = (0, _githubConnector2.default)(sources);
	  var view$ = view(model(intent(sources)));
	...
	function init() {
	  ...
	  if (HashSearch.keyExists('token')) {
	    Trello.authorize({
	      name: _constants2.default.APP_NAME,
	      expiration: "never",
	      interactive: false,
	...
	module.exports = {
	  ...
	  run: function run() {
	    _core2.default.run(main, {
	      ...
	      message: (0, _messageDriver.makeMessageDriver)()
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29)(module), (function() { return this; }()), __webpack_require__(30)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockDOMSource = __webpack_require__(90);
	var h = __webpack_require__(35);
	var hh = __webpack_require__(91)(h);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var attributeHook = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(h) {/* eslint-disable */
	'use strict';
	...
	var isVNode = __webpack_require__(40);
	var isVText = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(28);
	var fromEvent = __webpack_require__(56);
	var VDOM = {
	  h: __webpack_require__(35),
	  diff: __webpack_require__(57),
	  patch: __webpack_require__(63),
	  parse: typeof window !== "undefined" ? __webpack_require__(72) : function () {}
	};
	...
	try {
	  matchesSelector = __webpack_require__(76);
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isWidget = __webpack_require__(41)
	var isThunk = __webpack_require__(42)
	var handleThunk = __webpack_require__(60)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(65)
	var isArray = __webpack_require__(34)

	var render = __webpack_require__(67)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var applyProperties = __webpack_require__(68)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propertyMap = __webpack_require__(73);
	var namespaceMap = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(28);
	var toHTML = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isThunk = __webpack_require__(42);
	var isWidget = __webpack_require__(41);
	var softHook = __webpack_require__(48);
	var attrHook = __webpack_require__(54);
	var paramCase = __webpack_require__(81);
	var createAttribute = __webpack_require__(87);
	var voidElements = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(82)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(83)

	var NON_WORD_REGEXP = __webpack_require__(84)
	var CAMEL_CASE_REGEXP = __webpack_require__(85)
	var TRAILING_DIGIT_REGEXP = __webpack_require__(86)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(79);
	var propConfig = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function TrelloConnector(sources) {
	  var intent = function intent(DOM) {
	    return {
	      login$: DOM.select('#trello-login').events('click').map(function (ev) {
	        return true;
	      }),
	      logout$: DOM.select('#trello-logout').events('click').map(function (ev) {
	        return true;
	      })
	    };
	  };
	  ...
	  var model = function model(actions) {
	    var logout$ = actions.logout$.startWith(false).map(function (ev) {
	      if (!ev) return;
	      Trello.deauthorize();
	      location.reload();
	    });

	    var login$ = actions.login$.startWith(false).map(function (ev) {
	      if (!ev) return;
	      Trello.setKey(_constants2.default.TRELLO_KEY);
	      Trello.authorize({
	        name: _constants2.default.APP_NAME,
	        type: "redirect",
	        expiration: "never",
	  ...
	  var loggedInView = function loggedInView() {
	    return (0, _dom.div)({ className: 'panel', id: 'trello-loggedin' }, [(0, _dom.p)("You are already authorized. If something doesn't work, try logging out using the button below, and logging back in."), (0, _dom.a)({ className: 'medium success button', id: 'trello-logout' }, 'Log out')]);
	  };

	  var loggedOutView = function loggedOutView() {
	    return (0, _dom.div)({ className: 'panel', id: 'trello-loggedout' }, [(0, _dom.p)("To get going, you'll need to authorize the extension to use your Trello account."), (0, _dom.p)("Do it by clicking the big Authorize button below."), (0, _dom.a)({ className: 'medium success button', id: 'trello-login' }, 'Authorize')]);
	  };

	  var view = function view(state) {
	    return Observable.combineLatest(state.login$, state.logout$, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function GitHubConnector(sources) {
	  var intent = function intent(DOM) {
	    return {
	      login$: DOM.select('#github-login').events('click').map(function (ev) {
	        return true;
	      }),
	      logout$: DOM.select('#github-logout').events('click').map(function (ev) {
	        return true;
	      })
	    };
	  };

	  var model = function model(message, actions) {
	    var logout$ = actions.logout$.map(function (ev) {
	      if (!ev) return;
	      return { kind: _messages2.default.GITHUB_LOGOUT };
	    });

	    var login$ = actions.login$.startWith(false).map(function (ev) {
	      if (!ev) return;
	      return { kind: _messages2.default.GITHUB_LOGIN };
	    });
	    return {
	      message: logout$.merge(login$).startWith({ kind: _messages2.default.GITHUB_STATE })
	    };
	  };

	  var loggedInView = function loggedInView() {
	    return (0, _dom.div)({ className: 'panel', id: 'github-loggedin' }, [(0, _dom.p)("You are already authorized. If something doesn't work, try logging out using the button below, and logging back in."), (0, _dom.a)({ className: 'medium success button', id: 'github-logout' }, 'Log out')]);
	  };

	  var loggedOutView = function loggedOutView() {
	    return (0, _dom.div)({ className: 'panel', id: 'github-loggedout' }, [(0, _dom.p)("To get going, you'll need to authorize the extension to use your GitHub account."), (0, _dom.p)("Do it by clicking the big Authorize button below."), (0, _dom.a)({ className: 'medium success button', id: 'github-login' }, 'Authorize')]);
	  };

	  var view = function view(message, state) {
	    return message.get(_messages2.default.GITHUB_STATE).map(function (state) {
	      if (state.authorized) {
	        return loggedInView();
	      } else {
	        return loggedOutView();
	  ...
	  var intent$ = intent(sources.DOM);
	  var model$ = model(sources.message, intent$);
	  var view$ = view(sources.message, model$);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.makeMessageDriver = makeMessageDriver;
	...
	function makeMessageDriver() {
	  var event$$ = new _rx2.default.Subject();
